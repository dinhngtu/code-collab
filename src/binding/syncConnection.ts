...
export class SyncConnection {
    ...
    public autoshare : IAutosharer = new Autosharer(this.syncPortal, this.editorManager, this.bufferBindingFactory, this.editorBindingFactory, this.bindingStorage);
